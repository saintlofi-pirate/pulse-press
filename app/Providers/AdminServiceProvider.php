    ...
    private function publicContentMap(): array
    {
        ...
        foreach ($items as $postId) {
            ...
            $map[(string) $id] = sprintf(
                '%s #%d%s',
                $title !== '' ? $title : __('(no title)', 'pulse-press'),
                $id,
    ...
    private function i18n(): array
    {
        return [
            ...
            'sections' => [
                ...
                'reactionsHelper' => __('Pick which reactions appear in the widget, which ones trigger email capture, and who can react.', 'pulse-press'),
            ...
            'fields' => [
                ...
                'widgetDesignHelper'        => __('Includes Stitch-inspired layouts: clean bars, progress split, vertical rail, and clap counter patterns.', 'pulse-press'),
                'widgetDesignChoices'       => [
                    'minimal'        => __('Minimal', 'pulse-press'),
                    'expressive'     => __('Expressive', 'pulse-press'),
                    'minimalist'     => __('Minimalist', 'pulse-press'),
                    'subtle_text'    => __('Subtle text', 'pulse-press'),
                    'progress_split' => __('Progress split', 'pulse-press'),
                    'vertical_rail'  => __('Vertical rail', 'pulse-press'),
                    'clap_counter'   => __('Clap counter', 'pulse-press'),
                ],
                ...
                'primaryColorLabel'         => __('Primary color', 'pulse-press'),
                'primaryColorHelper'        => __('Used for selected states, progress fills, focus accents, and motion effects.', 'pulse-press'),
                'animationModeLabel'        => __('Animation', 'pulse-press'),
                'animationModeHelper'       => __('Control the amount of motion used when visitors press a reaction.', 'pulse-press'),
                'animationModeChoices'      => [
                    'none'       => __('None', 'pulse-press'),
                    'subtle'     => __('Subtle', 'pulse-press'),
                    'spring'     => __('Spring', 'pulse-press'),
                    'burst'      => __('Burst', 'pulse-press'),
                    'float'      => __('Float', 'pulse-press'),
                    'glow'       => __('Glow', 'pulse-press'),
                    'count_bump' => __('Count bump', 'pulse-press'),
                    'trail'      => __('Trail', 'pulse-press'),
                ],
                ...
                'hideOnPostIdsLabel'        => __('Never show on posts/pages', 'pulse-press'),
                'hideOnPostIdsHelper'       => __('Enter comma-separated post IDs, or choose a published post/page below. These IDs always suppress the widget.', 'pulse-press'),
                'hideOnPostIdsPlaceholder'  => __('Example: 12, 48, 103', 'pulse-press'),
                'hideOnPostIdsSelectLabel'  => __('Add by title', 'pulse-press'),
                'hideOnPostIdsSelectOption' => __('Select a post or page…', 'pulse-press'),
                ...
                'enabledReactionsLabel'     => __('Visible reactions', 'pulse-press'),
                'enabledReactionsHelper'    => __('Only selected reactions appear on the frontend widget.', 'pulse-press'),
